...
##        plt.show()
        ...
        print("Info: Expected number of pulse is :  ")
        print(noPulsesExpected)

        #color.write("Info: Actual number of pulse is :  ","KEYWORD")
        print("Info: Actual number of pulse is :  ")
        ...
        print("Healthy Segment. Data is being Processed \n")
        #Comment the line below when you don't want the figures
        #PlotSignals()
        #plt.show()
        ...
        print("Info: Correction Factor is :  ")
